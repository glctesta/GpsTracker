...
class RaceTracker {
    ...
    addEventListeners() {
        this.ui.menuToggleBtn.addEventListener('click', () => this.toggleMenu());
        
        // Auto-close menu when interacting with key elements
        this.ui.gpxInput.addEventListener('change', (e) => {
            this.handleFileUpload(e);
            this.closeMenu();
        });
        
        this.ui.skipBtn.addEventListener('click', () => {
            this.skipCurrentWaypoint();
            this.closeMenu();
        });
    ...
    toggleMenu() {
        this.ui.sidebar.classList.toggle('menu-closed');
    }

    closeMenu() {
        this.ui.sidebar.classList.add('menu-closed');
    }
